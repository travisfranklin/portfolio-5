...
excerpt: My first project in the Udacity Front End Nanodegree program, focusing on layout basics to build a simple portfolio-style site. Features semantic HTML5, responsive design, and clean CSS styling fundamentals.
publishDate: 2019-06-11T13:52:21.187Z
featureImage:
    src: /FEND-Project1.jpg
    alt: A picture of the result of Udacity Frontend Project 1, a simple portfolio site.
seo:
    image:
        src: /FEND-Project1.jpg
tags:
