...
excerpt: A classic Frogger arcade game clone built with HTML5 Canvas and vanilla JavaScript. Features sprite collision detection, object-oriented programming with classes and IIFEs, and arrow key navigation controls.
publishDate: 2019-08-02T20:52:00.000Z
featureImage:
    src: /fend-project3.jpg
    alt: Picture of the frogger clone game I created.
seo:
    image:
        src: /fend-project3.jpg
tags:
