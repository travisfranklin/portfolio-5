...
excerpt: The final project of my Udacity Front-End Nanodegree program, testing everything learned in 3 months. Features ES6 syntax, responsive design, Mapbox API integration, accessibility standards, and service workers for offline functionality.
publishDate: 2019-10-01T20:52:00.000Z
featureImage:
    src: /fend-project5.jpg
    alt: 'A picture of the Gourm.et website.'
    caption: Bon Appétit!
seo:
    image:
        src: /fend-project5.jpg
...
<ImageGallery
  images={[
    { src: "/fend5_Desktop.jpg", alt: "Gourm.et desktop view" },
    { src: "/fend5_ipad.jpg", alt: "Gourm.et iPad view" },
    { src: "/fend5_iphone.jpg", alt: "Gourm.et iPhone view" }
  ]}
/>
...
<ImageGallery
  images={[
    { src: "/mapdisconnect.jpg", alt: "Map disconnect offline view" }
  ]}
/>
