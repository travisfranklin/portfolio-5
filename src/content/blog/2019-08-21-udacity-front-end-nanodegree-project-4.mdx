...
excerpt: A comprehensive testing project using the Jasmine testing suite to validate an RSS feed application. Demonstrates test-driven development principles, DOM manipulation testing, and asynchronous function validation.
publishDate: 2019-08-21T20:52:00.000Z
featureImage:
    src: /fend-project4.jpg
    alt: Picture of jasmine testing ui
seo:
    image:
        src: /fend-project4.jpg
tags:
